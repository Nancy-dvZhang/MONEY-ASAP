...
Right Regression with One-hot Encoding | 56397

Since this dataset inherently contains a high level of noises (people with exact same levels of all features still have different base salary), our simple linear regression is able to achieve relatively good prediction using coding as group mean with normalization as we compare its performance with optimized linear regression model. 
